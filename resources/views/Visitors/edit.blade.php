<x-layouts.app>
    <div class="max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-2">Bezoeker bewerken</h1>
        <p class="text-sm text-gray-600 dark:text-gray-400 mb-6">Werk het gekoppelde bezoekersprofiel bij.</p>
            ...
            <div>
                ...
                <select id="user_id" name="user_id" required
                    ...
                    @foreach ($users as $user)
                        <option value="{{ $user->id }}" @selected(old('user_id', $visitor->user_id) == $user->id)>

<x-layouts.app>
    <div class="max-w-2xl mx-auto">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400 mb-6">Koppel een user met rol visitor aan een bezoekersprofiel.</p>

        <form action="{{ route('visitors.store') }}" method="POST" class="space-y-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            @csrf

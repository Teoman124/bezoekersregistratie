<x-layouts.app>
    <div class="mx-auto max-w-3xl space-y-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Nieuw bericht</h1>
            <p class="text-sm text-gray-600 dark:text-gray-400">Stuur een bericht naar een gebruiker in de mailbox.</p>
        </div>
        ...
        <form action="{{ route('mailbox.store') }}" method="POST"
            ...
            <div>
                <label for="recipient_id"
                    class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">Ontvanger</label>
            ...
            <div>
                <label for="subject"
                    class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">Onderwerp</label>
            ...
            <div>
                <label for="body"
                    class="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">Bericht</label>
